...
class PDFManagerApp:
    def __init__(self, root):
        ...
        self.rasa_chatbot = RasaChatbot('rasa_chatbot.py')

        self.nlpaug_rephraser = NLPAugRephraser('nlpaug_rephraser.py')

        self.mymemory_translator = MyMemoryTranslator('mymemory_translstor.py')
